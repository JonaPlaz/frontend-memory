      ...
      {showInstructions && (
        <div className="fixed inset-0 bg-white p-8 overflow-y-auto z-50">
          ...
          <p className="text-left">
            ...
            CHESS. Développez vos compétences, grimpez dans les classements et maximisez vos récompenses !
          </p>
          ...
          <p className="text-left">
            ...
            etc.). Lors de votre inscription, nous vous offrons 100 CHESS pour commencer vos premières parties. Chaque
            nouvel utilisateur se voit attribuer un score initial de 100, qui reflète son niveau de jeu.
          </p>
          <h2 className="mt-6 font-bold">2. Système de scoring</h2>
          <p className="text-left">
            Chaque joueur dispose d’un scoring, affiché entre parenthèses après son pseudo. Exemple : JoueurX (120). Ce
            score évolue en fonction de vos performances :
          </p>
          ...
          <p className="text-left">
            ...
            une partie à 10 CHESS par joueur, un total de 20 CHESS est en jeu.
          </p>
          <ul className="list-disc pl-6">
            <li>Répartition des gains : Le vainqueur remporte 18 CHESS.</li>
            <li>2 CHESS sont prélevés par la plateforme pour couvrir les frais de fonctionnement.</li>
            <li>En cas d’égalité : La somme totale en jeu est divisée équitablement entre les deux joueurs.</li>
          </ul>
          ...
          <ul className="list-disc pl-6">
            <li>
              <strong>Proposer une égalité :</strong> Un joueur peut proposer une égalité en cliquant sur "Proposer une
              égalité". Si l’autre joueur accepte, la partie est déclarée nulle, et les gains sont partagés.
            </li>
            <li>
              <strong>Abandon :</strong> Un joueur peut abandonner à tout moment en cliquant sur "Abandonner". Dans ce
              cas, l’autre joueur est déclaré vainqueur et remporte les gains.
            </li>
          </ul>
          <p className="text-left">
